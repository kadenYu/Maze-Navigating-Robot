...
NOT_ALL_STOP CMPA #L_TRN  
             BNE NOT_L_TRN
             JSR L_TRN_ST
             BRA DISP_EXIT

NOT_L_TRN CMPA #L_ALIGN ; 
            BNE NOT_L_ALIGN ; H
            JSR L_ALIGN_ST ; 
            BRA DISP_EXIT ; 
            ; |
NOT_L_ALIGN CMPA #R_TRN
            BNE NOT_R_TRN
            JSR R_TRN_ST
            BRA DISP_EXIT
            
NOT_R_TRN   CMPA #R_ALIGN
            JSR R_ALIGN_ST
            BRA DISP_EXIT           
...
NO_BOW            LDAA    SENSOR_STBD                                                            
                  ...
                  CMPA    BASE_STARBOARD                                                              
                  BPL     PARTIAL_R_TRN                                                        
                  BMI     ALIGNED_EXIT       ;If certain conditions are met, certain turns will be excecuted                  
...
L_ALIGN_ST        MOVB    #FWD, CRNT_STATE                                                        
                  JSR     INIT_FWD                                                                
                  JMP     LR_EXIT                                                        
